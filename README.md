This project aims to predict the molecular weight of different compounds using regression models. As an initial effort, only a linear regression has been conducted using Nabayan Saha's
